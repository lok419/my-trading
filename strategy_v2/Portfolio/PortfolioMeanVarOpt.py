...
class PortfolioMeanVarOpt(PortfolioBase):
    '''
        Mean Variance Optimization
        Mean Variance Optimization is done such that it optimize the Portfolio Sharp while maintain the volatility target

        ******************** IMPORTANT ******************** 
        This class does not aim to predict any returnability in the future, but only attribute the captial based on historical performance
        ANY return prediction / alpha generation should be done within strategy classes
        ***************************************************
    ''' 
